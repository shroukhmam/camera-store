      ...
      <div className="relative group bg-white p-4 rounded-xl shadow-md h-full flex flex-col hover:shadow-lg transition-all duration-300">
        <div className="relative flex-grow">
          ...
          <div className="absolute top-2 right-2 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition">
            <button className="bg-white p-2 rounded-full shadow text-orange-500 hover:bg-orange-100"><FaBalanceScale /></button>
            <button className="bg-white p-2 rounded-full shadow text-orange-500 hover:bg-orange-100"><FaSearch /></button>
            <button className="bg-white p-2 rounded-full shadow text-orange-500 hover:bg-orange-100"><FaHeart /></button>
          </div>
        </div>
          ...
          <div className="relative">
            <button
                className={`mt-3 w-full py-2 rounded flex items-center justify-center ${
                    selectedOption ? 'bg-orange-500 hover:bg-orange-600' : 'bg-black hover:bg-gray-800'
                } text-white`}
